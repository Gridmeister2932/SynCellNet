...
file_real_High = '3. Stem_High_Raw_Finalized.csv'
file_synthetic_High = 'recovered_gene_expression_High_class_2570.csv'
file_real_Low = '3. Differential_Low_Raw_Finalized.csv'
file_synthetic_Low = 'recovered_gene_expression_Low_class_2570.csv'
...
plt.xlabel('Gene Expression Value', fontsize = 20)
...
plt.step(x_rl, y_rl, where='mid', linewidth=3, label='Real Differentiated', linestyle='-.')
plt.step(x_sl, y_sl, where='mid', linewidth=3, label='Synthetic Differentiated', linestyle='-')
'''
